...
import { productionListEng, productionListEsp } from '../data';
import styles from '../styles/Projects.module.css';

const InProduction = ({ language }) => {
  const productionList =
    language === 'en' ? productionListEng : productionListEsp;
  return (
    <SectionWrapper
      title={language === 'en' ? 'In Production' : 'En Producción'}
      scroll="inDevelopment"
      inverted
    >
